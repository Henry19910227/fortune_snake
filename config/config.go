...
func (c *config) FreeBucketConfig() []*model.BucketConfig {
	return []*model.BucketConfig{
		...
		{LowerLimit: 50, UpperLimit: 55, MaxCapacity: 30},
		{LowerLimit: 55, UpperLimit: 60, MaxCapacity: 30},
		{LowerLimit: 60, UpperLimit: 65, MaxCapacity: 30},
		{LowerLimit: 65, UpperLimit: 70, MaxCapacity: 30},
		{LowerLimit: 70, UpperLimit: 75, MaxCapacity: 30},
		{LowerLimit: 75, UpperLimit: 80, MaxCapacity: 30},
		{LowerLimit: 80, UpperLimit: 85, MaxCapacity: 30},
		{LowerLimit: 85, UpperLimit: 90, MaxCapacity: 30},
		{LowerLimit: 90, UpperLimit: 95, MaxCapacity: 30},
		...
		{LowerLimit: 1000, UpperLimit: 2450, MaxCapacity: 2},
		{LowerLimit: 2450, UpperLimit: 2500, MaxCapacity: 1},
	}
}
